  ...
  setDogComment(newTitle);
    ...
    return (
      <FlexBox>
        ...
        <div>
          <DogGender>강아지 이름
          <DogTitleInput placeholder="강아지 이름을 입력하세요" onChange={dogNameChangeHandler}/>
          </DogGender>
           
           <DogGender>
             성별
          <input type="checkbox" name="check1" id="check1" value="1" class="checkbox1" onChange={dogGenderChangeHandler}/>
    <label for="check1">남</label>
    <input type="checkbox" name="radio1" id="radio1" value="1" class="checkbox1" onChange={dogGenderChangeHandler}/>
...
<option value="8세이상">8세이상</option>
       ...
       중성화여부
          <input type="checkbox" name="check1" id="check1" value="예" class="checkbox1" onChange={neutralChangeHandler}/>
    <label for="check1">예</label>
    <input type="checkbox" name="radio1" id="radio1" value="아니오" class="checkbox1" onChange={neutralChangeHandler}/>
    <label for="radio1">아니오</label>
       </DogGender>
       <div>강아지 한줄평
          <DogTitleInput placeholder="강아지를 소개해주세요!" onChange={dogCommentChangeHandler}/>
          </div>
          <DogGender>
          <Button>취소</Button>
         <Button onClick={()=>dispatch(DogActions.signDogAPI(dogGender,dogName,dogSize,dogBreed,dogAge,neutral,dogComment,imgFile))}>제출</Button>
        </DogGender>
