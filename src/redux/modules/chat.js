...
const inBoxMD = () => {
  return function (dispatch, getState, { history }) {
    axios({
      method: "GET",
      url: "http://52.78.6.138/chat/inbox",
      data: {},
      headers: {
...
const outBoxMD = () => {
  return function (dispatch, getState, { history }) {
    axios({
      method: "GET",
      url: "http://52.78.6.138/chat/outBox",
      data: {},
      headers: {
        Accept: "application/json",
        authorization: `Bearer ${getCookie("token")}`,
...
const sendMessageMD = (receiverId, message, type) => {
  return function (dispatch, getState, { history }) {
    axios({
      method: "POST",
      url: `http://52.78.6.138/chat/${receiverId}`,
      data: { message },
      headers: {
        Accept: "application/json",
        authorization: `Bearer ${getCookie("token")}`,
...
const sendNotificationMD = (receiverId, type, postId) => {
  return function (dispatch, getState, { history }) {
    axios({
      method: "POST",
      url: `http://52.78.6.138/notification/${receiverId}`,
...
const getDetailMD = (chatId) => {
  return function (dispatch, useState, { history }) {
    axios({
      method: "GET",
      url: `http://52.78.6.138/chat/${chatId}`,
      data: {},
      headers: {
        Accept: "application/json",
        authorization: `Bearer ${getCookie("token")}`,
...
const deleteInMessageMD = (receiverId, senderId, chatId) => {
  return function (dispatch, useState, { history }) {
    axios({
      method: "POST",
      url: `http://52.78.6.138/chat/${receiverId}/${senderId}/${chatId}`,
      data: {},
      headers: {
        Accept: "application/json",
        authorization: `Bearer ${getCookie("token")}`,
