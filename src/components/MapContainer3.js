...
const MapContainer3 = () => {
    ...
    <div id="menu_wrap" class="bg_white">
      ...
      <FormControl sx={{width:300}}>
        ...
        > 
          ...
          <option value="부산광안리해수욕장">부산 광안리해수욕장</option>
    ...
    {is_modal? <MarkerModal close={closeModal} locationCategory={check}latitude={latitude} longitude={longitude} placename={placename}/> : null }
    </div>
